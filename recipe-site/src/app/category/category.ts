...
export class CategoryComponent implements OnInit {
  ...
  allProducts: Products[] = [
    ...
    { id: 48, name: 'Macaroons', description: 'Crispy meringue with thick and delicate cream and the filling inside of whatever taste you like', time: '50 minutes', category: 2, image: 'https://i.pinimg.com/736x/25/04/de/2504de4febb005f1d9e27d0fb98bd770.jpg' },
    { id: 12, name: 'Donuts', description: 'Fluffy sweet dough coated in a chocolate', time: '30 minutes', category: 2, image: 'https://media.istockphoto.com/id/2191474401/tr/fotoğraf/tasty-assorted-donuts.jpg?s=170667a&w=0&k=20&c=OclCvMSladT2oH7DLr8eEbcEQnEymasTd36bCPMzrKI=' },
    { id: 13, name: 'Cookies', description: 'Crispy cookies with rich amount of chocolate in it.', time: '35 minutes', category: 2, image: 'https://avatars.mds.yandex.net/i?id=c927c27e18df2cf9252fe63d3355af45_l-5413570-images-thumbs&n=13' },
    { id: 14, name: 'Merringue roulette', description: 'A bit crispy and delicate layer of merringue, with light and sweet cream inside.', time: '30 minutes', category: 2, image: 'https://i.pinimg.com/originals/6a/ad/4c/6aad4c77d44bafd2d226d3de9ab79a05.jpg' },
    { id: 15, name: 'Ice cream', description: 'Thick and delicate cold dessert with differernt tastes.', time: '20 minutes', category: 2, image: 'https://avatars.mds.yandex.net/i?id=519607bdda07a734db4339601eff17fd_l-4079997-images-thumbs&n=13' },
    { id: 16, name: 'Iced coffee', description: 'Cold and refreshing coffee with ice cubes.', time: '10 minutes', category: 3, image: 'https://www.tastingtable.com/img/gallery/incorporate-bourbon-into-your-cold-foam-for-a-boozy-iced-coffee/l-intro-1717439952.jpg' },
    { id: 17, name: 'Smoothie', description: 'A blended drink made from fruit, yogurt or milk, and sometimes vegetables, creating a creamy, nutritious beverage.', time: '8 minutes', category: 3, image: 'https://png.pngtree.com/thumb_back/fh260/background/20231018/pngtree-tempting-glass-of-cherry-smoothie-and-fresh-ingredients-on-a-rustic-image_13629848.png' },
    { id: 18, name: 'Milkshake', description: 'A thick and creamy drink made with milk, ice cream, and flavorings like chocolate or vanilla.', time: '10 minutes', category: 3, image: 'https://avatars.mds.yandex.net/i?id=98d11be108de54ccf1ceaf0e713807a3_l-16999685-images-thumbs&n=13' },
    { id: 19, name: 'Marroccan tea', description: 'Sweet tea made by steeping green tea with fresh mint leaves and sweetened with sugar.', time: '5 minutes', category: 3, image: 'https://avatars.mds.yandex.net/i?id=dcb8d96c18f1dc89c52fa2c28aa6a0f1_l-10613167-images-thumbs&n=13' },
    { id: 20, name: 'Bubble tea', description: 'Red colored sweet tea having gunpowder, mint and sugar.', time: '20 minutes', category: 3, image: 'https://avatars.mds.yandex.net/i?id=dc2b633f8b97f67de78911d8c6a3f68b_l-4613979-images-thumbs&n=13' },
    { id: 21, name: 'Lemonade', description: 'A sweet and tart drink made from lemon juice, water, and sugar, often served chilled.', time: '6 minutes', category: 3, image: 'https://media.istockphoto.com/id/1479321833/ru/фото/освежающий-коктейль-мохито-с-лаймом-кубиками-льда-и-зелеными-листьями-мяты-на-черном-фоне.jpg?s=612x612&w=0&k=20&c=g21SbbZS9GVihsg_BeRKLhWMxGrT34Xk_9nxGFuvWao=' },
    { id: 22, name: 'Mojito', description: 'A refreshing cocktail made with rum, mint, lime, sugar, and soda water, perfect for hot weather.', time: '9 minutes', category: 3, image: 'https://avatars.mds.yandex.net/i?id=ac44fe343530e5b836060591d8ed6c1c_l-5296622-images-thumbs&n=13' },
    { id: 23, name: 'Margarita', description: 'A classic cocktail made with tequila, lime juice, and orange liqueur, served with a salted rim.', time: '10 minutes', category: 3, image: 'https://media.istockphoto.com/id/1318616344/ru/фото/классический-коктейль-маргарита-с-соком-лайма-и-кубиком-льда-на-черном-фоне-с-всплеском.jpg?s=612x612&w=0&k=20&c=1AEaXmnCPxGGHTxd-nMxSZQxs9Udpl4jlsxgvJ0JzhM=' },
    { id: 24, name: 'Caesar', description: 'A classic salad made with romaine lettuce, croutons, parmesan cheese, and Caesar dressing, often topped with grilled chicken or bacon', time: '15 minutes', category: 4, image: 'https://static.toprecepty.cz/fotky/clanky_hlavni/healthy-couture-salad-with-grilled-chicken-fillet-generated-by-ai-860-484-wide.jpg' },
    { id: 25, name: 'Tabbouleh', description: 'A refreshing Middle Eastern salad made with parsley, bulgur wheat, tomatoes, cucumbers, mint, and dressed with olive oil, lemon juice, and salt.', time: '20 minutes', category: 4, image: 'https://avatars.mds.yandex.net/i?id=a844929061487c318e987477d4429ca0_l-4886334-images-thumbs&n=13' },
    { id: 26, name: 'Pasta Salad', description: 'A versatile salad made with cooked pasta, often mixed with vegetables, cheese, and a tangy dressing, commonly served chilled.', time: '17 minutes', category: 4, image: 'https://png.pngtree.com/background/20230427/original/pngtree-an-attractive-dinner-plate-containing-pasta-salad-picture-image_2495862.jpg' },
    { id: 27, name: 'Nicoise Salad', description: 'A French salad featuring tuna, hard-boiled eggs, green beans, potatoes, olives, tomatoes, and anchovies, typically served with a vinaigrette dressing.', time: '20 minutes', category: 4, image: 'https://avatars.mds.yandex.net/i?id=926e70d37c66dc917aed28106eef04ee_l-5229055-images-thumbs&n=13' },
    { id: 28, name: 'Greek salad', description: 'Fresh dish made with tomatoes, cucumbers, red onions, olives, feta cheese, and olive oil, typically seasoned with oregano.', time: '10 minutes', category: 4, image: 'https://img.freepik.com/free-photo/vegetable-salad-with-white-cheese_140725-4329.jpg?semt=ais_hybrid&w=740&q=80' },
    { id: 29, name: 'Funchosa', description: 'Type of translucent Asian noodle made from starch, often served in soups, stir-fries, or salads, and commonly paired with vegetables, meats, or seafood.', time: '30 minutes', category: 4, image: 'https://images.news.ru/photo/30b3f1da-0a26-11f0-b3e7-ac1f6bad3ff4_930.jpg' },
    { id: 30, name: 'Caprese Salad', description: 'An Italian salad made with fresh mozzarella, tomatoes, basil, olive oil, and balsamic vinegar, offering a light and flavorful combination.', time: '15 minutes', category: 4, image: 'https://www.koolinar.ru/all_image/article/4/4961/article-08e9f5a8-35f5-49cd-b8ef-04e8b7812d0b_large.png' },
    { id: 31, name: 'Cobb Salad', description: 'A hearty American salad made with mixed greens, grilled chicken, bacon, hard-boiled eggs, avocado, blue cheese, tomatoes, and a tangy dressing.', time: '20 minutes', category: 4, image: 'https://thumbs.dreamstime.com/b/здоровый-салат-кобб-с-сыром-и-яйца-помидоры-бекона-авокадо-курицу-182177379.jpg' },
    {
  ...
  addToFavorites(recipe: any) {
    ...
    const cleanId = parseInt(recipe.id, 10);

    if (isNaN(cleanId)) {
      console.error('Неверный ID рецепта');
      return;
    }
    this.apiService.addToFavorites(cleanId).subscribe({
      next: (response: any) => {
        alert(`${recipe.name} добавлен в избранное!`);
      },
      error: (err: any) => {
        console.error('Ошибка бэкенда:', err);
        if (err.status === 404) {
          alert('Ошибка 404: Рецепт с таким ID не найден в базе данных Django!');
        } else {
  ...
  ngOnInit(): void {
    ...
    this.apiService.getRecipesByCategory(id).subscribe({
      next: (data) => {
        this.recipes = data;
      },
